...
// GET /api/products
var productsProxy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            case 0:
                if (!req.user || !(0, checkRole_1.checkRole)(['admin'], req.user)) {
                    if (logs)
                        req.payload.logger.error({ err: "You are not authorized to access products" });
...
exports.productsProxy = productsProxy;
