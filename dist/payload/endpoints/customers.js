...
// GET /api/customers
var customersProxy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var customers, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!req.user || !(0, checkRole_1.checkRole)(['admin'], req.user)) {
                    if (logs)
                        req.payload.logger.error({ err: "You are not authorized to access customers" });
...
exports.customersProxy = customersProxy;
